...
export default function Home() {
  return (
    <div className="bg-gradient-to-tl from-blue-600 via-transparent to-purple-400">
                ...
                <div>
                  ...
                  >
                    <li>
                      <a
                        href="#about"
                        className="block py-0.5 text-sm font-medium leading-6 text-slate-400 hover:text-slate-300 hs-scrollspy-active:text-blue-400 active"
                      >
                        ABOUT
                      </a>
                    </li>
                    <li>
                      <a
                        href="#experience"
                        className="block py-0.5 text-sm font-medium leading-6 text-slate-400 hover:text-slate-300 hs-scrollspy-active:text-blue-400"
                      >
                        EXPERIENCE
                      </a>
                    </li>
                ...
                <div id="scrollspy-2" className=" space-y-28">
                  <section id="about" className="lg: scroll-m-24">
                    ...
                    <p className="  font-medium leading-relaxed text-gray-400 mb-4">
                      ...
                      across devices, and optimized for performance. By
                      leveraging the latest web technologies and best practices,
                      I ensure that every website I create is not only visually
                      stunning but also fast-loading and accessible to a wide
                      range of users.
                    </p>
